...
const FAQ = () => {
  ...
  const faqs = [
    ...
    {
      question: 'هل المركز معتمد من هدف؟',
      answer: 'نعم , الأكاديمية الوطنية العالي للتدريب معتمده من (هدف)و(الصندوق المهني) .'
    },
    {
      question: 'هل CEH  مسترده؟',
      answer: ' مباشرةً بـCEH إمكانية الاسترداد عبر هدف حسب الأهلية.'
    },
    {
      question: 'هل تضمنون وظيفة؟',
      answer: 'نقدّم خبرة عملية حقيقية وشهادة خبرة سنة بعد إتمام المسارات، ونساعدك في الجاهزية، لكن لا نعد بوظيفة مضمونة.'
    },
    {
      question: 'طرق الدفع؟',
